...
`],encapsulation:2,changeDetection:0})}return a})();var Hr=(()=>{class a{static \u0275fac=function(e){return new(e||a)};static \u0275mod=at({type:a});static \u0275inj=nt({imports:[mt]})}return a})();function Yl(a,i){if(a&1){let t=E();r(0,"button",6),g("click",function(){D(t);let n=b();return S(n.toggle.emit())}),r(1,"mat-icon"),l(2,"menu"),s()()}}function Xl(a,i){if(a&1&&(r(0,"div",5)(1,"span",7),l(2),s(),r(3,"div",8),k(4,"t-avatar",9),s()()),a&2){let t,e,n,o=b();d(2),C((t=o.activeUser())==null?null:t.name),d(2),_("name",((e=o.activeUser())==null?null:e.name)||"")("avatar",(n=o.activeUser())==null?null:n.avatar)("size",36)}}var Cn=class a{isMobile=W(!1);title=W("Trackify");activeUser=W(null);toggle=te();themeService=m(ui);static \u0275fac=function(t){return new(t||a)};static \u0275cmp=v({type:a,selectors:[["t-header"]],inputs:{isMobile:[1,"isMobile"],title:[1,"title"],activeUser:[1,"activeUser"]},outputs:{toggle:"toggle"},decls:8,vars:3,consts:[[1,"df","fx","jc-s","toolbar",2,"box-shadow","0 2px 6px rgb(0 0 0 / 15%)","z-index","10","position","relative"],[1,"df","ai-c","gap-2"],["mat-icon-button","","aria-label","Toggle sidenav"],["color","primary",2,"font-size","28px","width","28px","height","28px","margin-right","8px"],[1,"fs-20",2,"font-weight","400"],[1,"df","fd-r","ai-c","gap-2","px-8"],["mat-icon-button","","aria-label","Toggle sidenav",3,"click"],[1,"fs-14","fw-600","hide-on-mobile"],["routerLink","/settings",1,"cursor-pointer"],[3,"name","avatar","size"]],template:function(t,e){t&1&&(r(0,"mat-toolbar",0)(1,"div",1),x(2,Yl,3,0,"button",2),r(3,"mat-icon",3),l(4," track_changes "),s(),r(5,"span",4),l(6),s()(),x(7,Xl,5,4,"div",5),s()),t&2&&(d(2),w(e.isMobile()?-1:2),d(4),C(e.title()),d(),w(e.activeUser()?7:-1))},dependencies:[et,ie,Ze,Hr,Br,$,ft,Q,Z,Pe],encapsulation:2})};var Dn=class a{static \u0275fac=function(t){return new(t||a)};static \u0275cmp=v({type:a,selectors:[["app-root"]],decls:4,vars:3,consts:[["s",""],[3,"toggle","isMobile","title","activeUser"]],template:function(t,e){if(t&1){let n=E();r(0,"t-sidenav",null,0)(2,"t-header",1),g("toggle",function(){D(n);let c=xt(1);return S(c.toggleSidenav())}),s(),k(3,"router-outlet"),s()}if(t&2){let n=xt(1);d(2),_("isMobile",n.isMobile())("title",n.title())("activeUser",n.activeUser())}},dependencies:[Na,kn,Cn],encapsulation:2})};Aa(Dn,Nr).catch(a=>console.error(a));
